...
import pdb
import pprint
result_file_path ="C:\\Users\\49157\\PycharmProjects\\More_Exercises\\output.csv"

all_trades_raw = """PEP Short $153.68
Stop Loss $156.98
Target $146.10
...
def raw_string_to_dictionary_V2(input_string):
    input_as_list = input_string.split("\n\n")
    all_trades = []
    for trade in input_as_list:
     trade_split = trade.split()
...
def create_trades_file(file_path, trades):
